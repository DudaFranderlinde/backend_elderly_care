...
export class Entidades1717116842928 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "proposal" ("id_proposal" SERIAL NOT NULL, "status" "public"."proposal_status_enum" NOT NULL DEFAULT 'ENVIADO', "caregiver_id" integer, "elder_id" integer, CONSTRAINT "PK_86e880d17c245596947a4a91aaf" PRIMARY KEY ("id_proposal"))`);
        ...
        await queryRunner.query(`ALTER TABLE "proposal" ADD CONSTRAINT "FK_a6a51184c399338511b7658caa5" FOREIGN KEY ("elder_id") REFERENCES "elder"("id_elder") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "proposal" DROP CONSTRAINT "FK_a6a51184c399338511b7658caa5"`);
